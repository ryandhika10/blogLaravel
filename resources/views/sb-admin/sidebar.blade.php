<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @yield('main-active')">
                <a class="nav-link collapsed" href="/vendor/sb-admin/#" data-toggle="collapse" data-target="#main"
            ...
            @role('admin')
                ...
                <li class="nav-item @yield('user-active')">
                    <a class="nav-link collapsed" href="/vendor/sb-admin/#" data-toggle="collapse" data-target="#user"
            ...
            <li class="nav-item @yield('pengaturan-active')">
                <a class="nav-link collapsed" href="/vendor/sb-admin/#" data-toggle="collapse" data-target="#pengaturan"
