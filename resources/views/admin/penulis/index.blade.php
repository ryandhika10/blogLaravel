...
@section('content')
    ...
    <a href="/penulis/create" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Tambah penulis</a>
                    ...
                    <tr>
                        ...
                        <td width="15%">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="/penulis/{{ $row->id }}/konfirmasi" class="btn btn-danger btn-sm mr-1"><i class="fa-solid fa-trash-can"></i> Hapus</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
