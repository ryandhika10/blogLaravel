...
@section('content')
<a href="/banner/{{ $banner->id }}/edit" class="btn btn-primary btn-sm"><i class="fa-solid fa-edit"></i> Edit</a>
<a href="/banner" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
    <div class="card mt-3">
