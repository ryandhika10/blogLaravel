...
@section('content')
    ...
    <a href="/kategori/create" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Tambah Kategori</a>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="kategori/{{ $row->id }}/edit" class="btn btn-primary btn-sm mr-1"><i class="fa-solid fa-edit"></i> Edit</a>
